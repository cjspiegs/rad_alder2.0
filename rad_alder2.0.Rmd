...
isotope.df<- read.csv("/Users/cjspiegel/Desktop/Projects/rad_alder/isotopes/kosher_gherkin_alder_data.csv")
View(isotope.df)

#add new columns
isotope.df<- isotope.df%>%
  group_by(treatment, tree_origin, origin_site, tree_num, deploy, deploy_site, day)%>%
   mutate(weight.g = sample_weight/1000,
     totalC.g = totalC / 10^6,
          totalC.weight = totalC.g/weight.g,
          totalC.norm = totalC.g/0.003,
          totalN.g = totalN / 10^6,
          totalN.weight = totalN.g/weight.g,
          totalN.norm = totalN.g/0.003,
         c_n = totalC.norm / totalN.norm,
        log.c_n = log(c_n),
         perc.c = (totalC.norm) * 100,
         perc.n = (totalN.norm) * 100)
...
d13C.boxplot<- isotope.df %>%
  ggplot(aes(x = as.factor(treatment), y = scaled_d13C, fill = treatment, shape = treatment)) +
  geom_boxplot(position = position_dodge(width = 0.75), alpha = 0.7, width = 0.45) +
  geom_point(position = position_jitter(width = 0.1), size = 2, alpha = 0.4) + # Add jitter and reduce point size for raw data
  stat_summary(fun = "mean", geom = "point", size = 3, position = position_dodge(width = 0.75), color = "red2", alpha = 0.9) + # Add mean points
  scale_fill_manual(values = c("P" = "black", "AB" = "grey60"), labels = c("absent", "present")) +
...
d15N.boxplot<- isotope.df %>%
  ggplot(aes(x = as.factor(treatment), y = scaled_d15N, fill = treatment, shape = treatment)) +
  geom_boxplot(position = position_dodge(width = 0.75), alpha = 0.7, width = 0.45) +
  geom_point(position = position_jitter(width = 0.1), size = 2, alpha = 0.4) + # Add jitter and reduce point size for raw data
  stat_summary(fun = "mean", geom = "point", size = 3, position = position_dodge(width = 0.75), color = "red2", alpha = 0.9) + # Add mean points
  scale_fill_manual(values = c("P" = "black", "AB" = "grey60"), labels = c("absent", "present")) +
...
#total C boxplot
totalC.boxplot<- isotope.df %>%
  ggplot(aes(x = as.factor(treatment), y = totalC, fill = treatment, shape = treatment)) +
  geom_boxplot(position = position_dodge(width = 0.75), alpha = 0.7, width = 0.45) +
  geom_point(position = position_jitter(width = 0.1), size = 2, alpha = 0.4) + # Add jitter and reduce point size for raw data
  stat_summary(fun = "mean", geom = "point", size = 3, position = position_dodge(width = 0.75), color = "red2", alpha = 0.9) + # Add mean points
  scale_fill_manual(values = c("P" = "black", "AB" = "grey60"), labels = c("absent", "present")) +
  scale_shape_manual(values = c("AB" = 17, "P" = 16), labels = c("absent", "present")) +
  facet_grid(~day)+
  labs(fill = "Treatment", shape = "Treatment", x = "Treatment", y = expression("total C")) +
  guides(color = guide_legend(override.aes = list(shape = c(17, 16)))) +
  theme_bw() +
  theme(axis.text = element_text(size = 18),
        axis.title = element_text(size = 18),
...
#total N boxplot
totalN.boxplot<- isotope.df %>%
  ggplot(aes(x = as.factor(treatment), y = totalN, fill = treatment, shape = treatment)) +
  geom_boxplot(position = position_dodge(width = 0.75), alpha = 0.7, width = 0.45) +
  geom_point(position = position_jitter(width = 0.1), size = 2, alpha = 0.4) + # Add jitter and reduce point size for raw data
  stat_summary(fun = "mean", geom = "point", size = 3, position = position_dodge(width = 0.75), color = "red2", alpha = 0.9) + # Add mean points
  scale_fill_manual(values = c("P" = "black", "AB" = "grey60"), labels = c("absent", "present")) +
  scale_shape_manual(values = c("AB" = 17, "P" = 16), labels = c("absent", "present")) +
  facet_grid(~day)+
  labs(fill = "Treatment", shape = "Treatment", x = "Treatment", y = expression("total N")) +
  guides(color = guide_legend(override.aes = list(shape = c(17, 16)))) +
  theme_bw() +
  theme(axis.text = element_text(size = 18),
        axis.title = element_text(size = 18),
