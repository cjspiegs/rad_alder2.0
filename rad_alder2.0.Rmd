...
#c:n stats
c_n.bigmod<- lmer(c_n ~ treatment + (1 | site_num:tree_num) + (1 | tree_id), data = isotope.df)
c_n.mod2<- lmer(c_n ~ treatment + (1 | site_num:tree_num), data = isotope.df)
c_n.mod3<- lmer(c_n ~ treatment + (1 | site_num) + (1 | tree_num) + (1 | tree_id), data = isotope.df)
c_n.mod4<- lmer(c_n ~ treatment + (1 | tree_id), data = isotope.df)
c_n.mod5<- lmer(c_n ~ treatment + (1 | tree_num) + (1 | tree_id), data = isotope.df)
c_n.mod6<- lmer(c_n ~ treatment + (1 | site_num) + (1 | tree_id), data = isotope.df)
c_n.mod7<- lmer(c_n ~ treatment + (1 | site_num) + (1 | tree_num), data = isotope.df)
#AIC
AIC(c_n.bigmod,c_n.mod2,c_n.mod3,c_n.mod4,c_n.mod5,c_n.mod6,c_n.mod7 )
#check mod
c_n.mod2
plot(resid(c_n.mod2))
hist(resid(c_n.mod2))
#double checking
normalTest(resid(c_n.mod), method = "da")
#summary
summary(c_n.mod2)
anova(c_n.mod2)
```
...
#perc n stats
perc_n.bigmod<- lmer(perc.n ~ treatment + (1 | site_num:tree_num) + (1 | tree_id), data = isotope.df)
perc_n.mod2<- lmer(perc.n ~ treatment + (1 | site_num:tree_num), data = isotope.df)
perc_n.mod3<- lmer(perc.n ~ treatment + (1 | site_num) + (1 | tree_num) + (1 | tree_id), data = isotope.df)
perc_n.mod4<- lmer(perc.n ~ treatment + (1 | tree_id), data = isotope.df)
perc_n.mod5<- lmer(perc.n ~ treatment + (1 | tree_num) + (1 | tree_id), data = isotope.df)
perc_n.mod6<- lmer(perc.n ~ treatment + (1 | site_num) + (1 | tree_id), data = isotope.df)
perc_n.mod7<- lmer(perc.n ~ treatment + (1 | site_num) + (1 | tree_num), data = isotope.df)
#AIC
AIC(c_n.bigmod,c_n.mod2,c_n.mod3,c_n.mod4,c_n.mod5,c_n.mod6,c_n.mod7 )
#check mod
perc_n.mod2
plot(resid(perc_n.mod2))
hist(resid(perc_n.mod2))
#double checking
normalTest(resid(perc_n.mod2), method = "da")
#summary
summary(perc_n.mod2)
anova(perc_n.mod2)
