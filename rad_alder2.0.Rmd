...
meta_home_glmermod<- glmer(od_corrected_b_n ~ treatment + (treatment | decomp_day) + (1 | deploy) + (1 | site_num:tree_num), subset= group == "H", family = Gamma(link = "log"), data = true_home.16.meta.df)

#compare
AIC(meta_bighomemod,meta_home_glmermod)
                           
#check the best home mod
plot(resid(meta_bighomemod))
hist(resid(meta_bighomemod))
normalTest(resid(meta_bighomemod), method = "da")
...
#maybe we can see pairwise among decomp day
meta_home_decompmod<- lmer(log_od ~ treatment * decomp_day + (1 | deploy) + (1 | site_num:tree_num), subset= group == "H", data = true_home.16.meta.df)

#check out mod
plot(resid(meta_home_decompmod))
hist(resid(meta_home_decompmod))
#summary
summary(meta_home_decompmod)
#means
home_decomp_means <- emmeans(meta_home_decompmod2, ~ treatment : decomp_day)
...
pairs(home_decomp_means, adjust = "tukey")
