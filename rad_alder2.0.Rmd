...
meta_homemod2<- glmer(od_corrected_b_n ~ treatment + (1 | deploy) + (1 | decomp_day) + (1 | site_num:tree_num), subset= group == "H", family = gaussian(link= "log"), data = true_home.16.meta.df)

AIC(meta_homemod,meta_homemod2)
...
#####look within each decomposition day
#day 1
t.test(true_home.16.meta.df[true_home.16.meta.df$treatment=="P",])
meta_day1mod<- glmer(od_corrected_b_n ~ treatment + (1 | deploy) + (1 | site_num:tree_num), subset= group == "H" &  decomp_day == "3" , family = Gamma(link= "log"), data = true_home.16.meta.df)
#check mod
plot(resid(meta_day1mod))
hist(resid(meta_day1mod))
#day 1 null
meta_nullday1mod<- glmer(od_corrected_b_n ~ (1 | deploy) + (1 | site_num:tree_num), subset= group == "H" &  decomp_day == "3" , family = Gamma(link= "log"), data = true_home.16.meta.df)
#compare
